...
// Client IDs de Google OAuth (App CLIENTE). El backend acepta cualquiera de los 3
...
const GOOGLE_ANDROID_CLIENT_ID = '967962081340-tj95o2pbt1ilqrnn87va0pd5qra9pgka.apps.googleusercontent.com';

// Necesario para cerrar la ventana del navegador al volver del login.
WebBrowser.maybeCompleteAuthSession();

/**
 * Hook de "Continuar con Google".
